...
const SearchHeader: React.FC<SearchHeaderProps> = ({ isMobile }) => {
  ...
  const getBackgroundColor = () => {
    return uiIsDarkMode ? "var(--app-bg-color)" : "var(--ibm-forest)";
  };
  ...
  return (
    ...
    >
      ...
      {/* Invisible placeholder to match NotificationsHeader height */}
